...
for (col in colnames(test)[13:ncol(test)]) {
  ...
  if (is.factor(df[,col]) & col != 'month' & col != 'season' & col != 'weekday') {
    ...
    newlabels <- new[[1]]
    newlevels <- new[[2]]
    if (any(str_detect(substr(newlabels[1],2,2),c(paste0(c(3:10))))) & any(str_detect(substr(newlabels[1],4,nchar(newlabels[1])),paste0(c("\\+ times","I drink","ore","Agree","\\bagree","aily","ften","1-1"))))) {
...
df_healthdigest_BMF_p_select <- df_healthdigest_BMF_p[df_healthdigest_BMF_p$ORCI == 'bowel_ease' | 
                                      ...
                                      df_healthdigest_BMF_p$ORCI == 'ab_pain',
]
