...
#Remove any factors that have less than 10 responses per factor:
...
#For the proportional odds logistic regression (polr), remove unneeded features and covariates:
df2 <- df
...
dfOR_cip$variables <- c('BMF constipated', 'BMF diarrhea', 'BMF low normal', 'BMI', 'Sex', 'Age', 'eGFR')
...
```{r}
#the features with significant Odds Ratios for BMF-related coefficientss:
...
dietlife <- ggplot(df_dietlife_BMF_p_select, aes(x = value, y = factor(variables, levels = c("Age","Sex","BMI",'eGFR',"BMF diarrhea","BMF low normal", "BMF constipated")))) +
...
healthdigest <- ggplot(df_healthdigest_BMF_p_select, aes(x = value, y = factor(variables, levels = c("Age","Sex","BMI",'eGFR',"BMF diarrhea","BMF low normal", "BMF constipated")))) +
  facet_wrap(~ factor(ORCI)) +
...
full <- ggplot(df_full, aes(x = value, y = factor(variables, levels = c("Age","Sex","BMI",'eGFR',"BMF diarrhea","BMF low normal", "BMF constipated")))) +
